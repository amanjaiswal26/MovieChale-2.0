...
const MovieDetails = () => {
  ...
  return show ? (
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-40'>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <div className='relative flex flex-col gap-3'>
          ...
          <div className="flex items-center flex-wrap gap-4 mt-4">
            <button className='flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-lg hover:opacity-80 transition'>
            ...
            <a
              href="#dateSelect"
              className='bg-green-600 text-white px-4 py-2 rounded-lg hover:opacity-80 transition'
            >
              Buy Tickets
            </a>
      ...
      <p className='mt-15'>Your Favorite Cast</p>
